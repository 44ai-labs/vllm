        ...
        if (
            ...
            for req_id in structured_output_request_ids:
                ...
                if spec_grammar is not None:
                    ...
                    # the legacy accept-then-rollback walk over the live
                    # matcher. With no draft tokens there is nothing to roll
                    # back, so this is a single fill at the committed state.
